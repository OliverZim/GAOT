...
from .layers.mlp import AugmentedMLP
...
class GAOT(nn.Module):
    ...
    # 'absolute' = Sinusoidal absolute positional embeddings
    ...
    # 'learnable' = Learnable absolute positional embeddings
    def _compute_learnable_absolute_embeddings(self, positions, embed_dim):
        """
        Compute learnable absolute embeddings for the given positions using an MLP.
        """
        pos_emb = self.positional_embedding_mlp.forward(positions)
        return pos_emb
