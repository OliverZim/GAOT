...
class OptimizerArgsConfig:
    ...
    rebuild_graphs_after_n_epochs: int = (
        -1
    )  # Rebuild graphs and data loaders every n epochs
...
class AdamOptimizer:
    ...
    def __init__(self, params, config):
        ...
        self.rebuild_graphs_after_n_epochs = getattr(
            config, "rebuild_graphs_after_n_epochs", -1
        )
        self.lr = config.lr
    ...
    def optimize(
        ...
        for epoch in range(self.epoch):
            ...
            total_loss = 0.0
            if (
                self.rebuild_graphs_after_n_epochs > 0
                and epoch % self.rebuild_graphs_after_n_epochs == 0
                and epoch > 0
            ):
                trainer.update_graphs_and_loaders()
